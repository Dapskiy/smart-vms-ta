...
<body>
    ...
    <script>
        ...
        function showSuccessPopup(appt, method = 'face') {
            ...
            if(document.getElementById('si-pic-room')) document.getElementById('si-pic-room').textContent = 'Bapak/Ibu ' + picNameText;
    ...
    <div id="modal-face" class="modal-overlay">
        <div class="modal-box face-modal-box">
            ...
            <div style="margin-top: 0.6rem; padding: 0.5rem 1rem; background: rgba(99,102,241,0.08); border: 1px solid rgba(99,102,241,0.2); border-radius: 0.6rem; max-width: 300px; margin-left: auto; margin-right: auto;">
                <p style="font-size: 0.68rem; color: #94a3b8; line-height: 1.5; margin: 0; text-align: center;">
