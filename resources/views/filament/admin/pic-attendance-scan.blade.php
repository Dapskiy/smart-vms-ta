...
<div id="pic-attendance-scan-overlay" 
     x-data="{
         isCameraReady: false,
         ...
         async init() {
             ...
             window.addEventListener('attendance-scan-success', (e) => {
                 this.setMsg(e.detail.message, 'success');
                 this.setRing('green');
                 this.statusText = e.detail.message;
                 setTimeout(() => {
                     this.closeModal();
                 }, 1500);
             });
             
             window.addEventListener('attendance-scan-error', (e) => {
                 this.setMsg(e.detail.message, 'error');
                 this.setRing('red');
                 this.statusText = e.detail.message;
                 ...
                 setTimeout(() => {
                     if (!this.processing) {
                         ...
                         this.setMsg('Coba posisikan wajah kembali', 'info');
                         this.setRing('green');
                         this.detectionLoop();
                         this.landmarkLoop();
                     }
             ...
             try {
                 ...
                 if (this.livenessStep === 'straight') {
                     ...
                     if (nr > 0.62) {
                         ...
                         this.setMsg('Memverifikasi...', 'success');
                         this.arrowDir = 'none';
                         ...
                         if (window.Livewire) {
                             Livewire.dispatch('process-attendance-face', {
         ...
         closeModal() {
             ...
             window.dispatchEvent(new CustomEvent('close-modal', { detail: { id: 'scan_attendance' } }));
         },
    ...
    <div style="background: #0d1730; border: 1.5px solid rgba(16, 185, 129, 0.4); border-radius: 1.5rem; padding: 2rem; width: min(92vw, 400px); position: relative; box-shadow: 0 0 80px rgba(16, 185, 129, 0.15); display: flex; flex-direction: column; align-items: center; gap: 1rem;">
        ...
        <!-- Title & Subtitle -->
        <div style="font-size: 1.3rem; font-weight: 700; color: #f0f4ff; margin-bottom: 0.2rem; text-align: center;">Absensi Wajah PIC</div>
        <p style="font-size: 0.82rem; color: #8899bb; margin-bottom: 0.5rem; text-align: center;">Scan wajah Anda untuk melakukan absensi kehadiran</p>
